  ...
  module API
    module MetaV1
      ...
      class APIResource < Struct
        ...
        attribute :shortNames, Types::Strict::Array.of(Types::Strict::String).optional.default(proc { [] }.freeze)
        attribute :categories, Types::Strict::Array.of(Types::Strict::String).optional.default(proc { [] }.freeze)
      end
