...
module K8s
  ...
  class Config < ConfigStruct
    ...
    attribute :preferences, Types::Strict::Hash.optional.default(proc { {} }.freeze)
    attribute :clusters, Types::Strict::Array.of(NamedCluster).optional.default(proc { [] }.freeze)
    attribute :users, Types::Strict::Array.of(NamedUser).optional.default(proc { [] }.freeze)
    attribute :contexts, Types::Strict::Array.of(NamedContext).optional.default(proc { [] }.freeze)
    attribute :current_context, Types::Strict::String.optional.default(nil)
    attribute :extensions, Types::Strict::Array.optional.default(proc { [] }.freeze)
